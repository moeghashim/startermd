export const createPrdTemplate = () => `# Rule: Generating a Product Requirements Document (PRD)
...
Ask only the most critical questions needed to write a clear PRD. Limit questions to 3-5 critical gaps in understanding. Focus on areas where the initial prompt is ambiguous or missing essential context. Common areas that may need clarification:
...
export default createPrdTemplate;
